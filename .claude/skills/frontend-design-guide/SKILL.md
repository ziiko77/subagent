...
description: "컨벤션 적용", "코드 리뷰", "분석", "개선", "적용" 요청 시 사용. Sirloin OMS frontend design principles and coding standards. Readability, predictability, cohesion, and low coupling.
